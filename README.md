...
Investigate differences in screen usage between weekdays and weekends.

Understand how children prefer different devices and activities based on demographics.

Produce compelling visualizations such as bar graphs, histograms, box plots, heatmaps, and comparison charts.

Build user-friendly dashboards and reports suitable for non-technical audiences.
...
Name: Indian Kids Screentime 2025
...
Device Preference & Activity Usage Study

Weekday vs Weekend Behaviour Analysis

Demographic-Based Insights (age, gender, location)
